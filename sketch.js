...
function preload(){
    ...
    voltarimagem = loadImage("./Imagens/Reiniciar.png");

    venceuft = loadImage("./Imagens/Winner.png");
    perdeuft = loadImage("./Imagens/Game_Over.png");

    b1ft = loadImage("./Imagens/b1.png");
    b2ft = loadImage("./Imagens/b2.png");

    a1 = loadImage("./Imagens/Alien1.png");
    a2 = loadImage("./Imagens/Alien2.png");
    a3 = loadImage("./Imagens/Alien3.png");
    a4 = loadImage("./Imagens/Alien4.png");
    a5 = loadImage("./Imagens/Alien5.png");
    a6 = loadImage("./Imagens/Alien6.png");
...
function setup() {
    ...
    perdeu = createSprite(width/2, height/ 2);
    perdeu.addImage(perdeuft);
    perdeu.scale = 1;
...
function draw() {
    ...
    if(play){
        ...
        if (astronauta.isTouching(grupoAlien)) {
        play = false;
        perdeu.visible = true;
        astronauta.changeAnimation("parado_ft");
...
function gerarAlien(){
        ...
        if (frameCount % 100 == 0) {
            var alien = createSprite(windowWidth, windowHeight - 150, 20, 40);
